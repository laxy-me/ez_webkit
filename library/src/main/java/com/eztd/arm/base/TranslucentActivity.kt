...
import com.eztd.arm.tools.NotchUtil
import java.io.BufferedReader
import java.io.IOException
import java.io.InputStreamReader

abstract class TranslucentActivity : Activity() {
    ...
    fun addStatusBarHeightPaddingTop(view: View) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            view.setPadding(
                view.paddingLeft, view.paddingTop + extraHeight,
     ...
     * 判断是否为MIUI[6,9)
     */
    private fun betweenMIUI6And9(): Boolean {
        return try {
    ...
    private fun isFlyme(): Boolean {
        return try {
            val method =
                Build::class.java.getMethod("hasSmartBar")  // max4 会抛出java.lang.NoSuchMethodException: hasSmartBar []
            method != null
        } catch (e: Exception) {
