...
class PureWebActivity : BaseActivity() {
    ...
    private fun initData(intent: Intent) {
        titleBg = intent.getStringExtra(ExtraKeys.EX_STATE_BAR_BG)
        titleFieldColor = intent.getStringExtra(ExtraKeys.EX_STATE_BAR_FIELD_COLOR)
        mHasTitleBar = intent.getBooleanExtra(ExtraKeys.EX_HAS_TITLE_BAR, false)
        mTitle = intent.getStringExtra(ExtraKeys.EX_TITLE)
        mTitleTextColor = intent.getStringExtra(ExtraKeys.EX_TITLE_TEXT_COLOR)
        ...
        webBack = intent.getBooleanExtra(ExtraKeys.EX_WEB_BACK, true)
    }
