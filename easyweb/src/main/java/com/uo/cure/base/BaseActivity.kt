...
@Keep
open class BaseActivity : _root_ide_package_.com.uo.cure.base.TranslucentActivity() {
    protected var TAG = ""
    ...
    protected open fun requestPermission(
        ...
        ration: IntArray,
        callback: _root_ide_package_.com.uo.cure.base.BaseActivity.AfterPermissionGranted
    ) {
